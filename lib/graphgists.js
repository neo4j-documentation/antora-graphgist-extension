...
function generateJupyterNotebookAttachments(graphGists) {
...
function generateGraphGistCategoryPages(graphGists, pages, contentCatalog, asciidocConfig) {
  ...
  return Array.from(categoryPagesMap.values()).map((categoryPage) => {
...
function addGraphGistIndexPage(graphGists, pages, contentCatalog, asciidocConfig) {
  contentCatalog.addFile(createGraphGistIndexPage(graphGists, contentCatalog, asciidocConfig))
}
